...
COURSES['7mo-8vo'] = {
        ...
        activities: [
    {
        ...
        aLabel: "Answer",
        items: [
            { q: "What verb do you use with basketball?", a: "PLAY basketball", sideImg: DIBUJOS+'play-basketball.png', icon: "🏀", trans: "yo juego básquetbol" },
            { q: "What verb do you use with soccer?", a: "PLAY soccer    or    PLAY football", sideImg: DIBUJOS+'play-soccer.png', icon: "⚽", trans: "yo juego fútbol" },
            { q: "What verb do you use with tennis?", a: "PLAY tennis", sideImg: DIBUJOS+'play-tennis.png', icon: "🎾", trans: "yo juego tenis" },
            { q: "What verb do you use with handball?", a: "PLAY handball", sideImg: DIBUJOS+'play-handball.png', icon: "🤾", trans: "yo juego balonmano" },
            { q: "What verb do you use with swimming?", a: "GO swimming", sideImg: DIBUJOS+'go-swimming.png', icon: "🏊", trans: "yo voy a nadar" },
            { q: "What verb do you use with skiing?", a: "GO skiing", sideImg: DIBUJOS+'go-skiing.png', icon: "⛷️", trans: "yo voy a esquiar" },
            { q: "What verb do you use with running?", a: "GO running", sideImg: DIBUJOS+'go-running.png', icon: "🏃", trans: "yo voy a correr" },
    ...
    },
    {
        ...
        items: [
            { q: "What do you think about basketball?", a: "In my opinion, basketball is exciting!", sideImg: DIBUJOS+'play-basketball.png', icon: "🏀" },
            { q: "What do you think about soccer?", a: "In my opinion, soccer is fun!", sideImg: DIBUJOS+'play-soccer.png', icon: "⚽" },
            { q: "What do you think about swimming?", a: "In my opinion, swimming is relaxing!", sideImg: DIBUJOS+'go-swimming.png', icon: "🏊" },
            { q: "What do you think about tennis?", a: "In my opinion, tennis is interesting!", sideImg: DIBUJOS+'play-tennis.png', icon: "🎾" },
            { q: "What do you think about skiing?", a: "In my opinion, skiing is dangerous!", sideImg: DIBUJOS+'go-skiing.png', icon: "⛷️" },
            { q: "What do you think about running?", a: "In my opinion, running is boring / fun!", sideImg: DIBUJOS+'go-running.png', icon: "🏃" },
            { q: "What do you think about handball?", a: "In my opinion, handball is exciting!", sideImg: DIBUJOS+'play-handball.png', icon: "🤾" },
