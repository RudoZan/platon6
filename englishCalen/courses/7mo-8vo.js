...
COURSES['7mo-8vo'] = {
        ...
        activities: [
    {
        ...
        aLabel: "Answer",
        items: [
            { q: "What verb do you use with basketball?", a: "PLAY basketball", sideImg: DIBUJOS+'play-basketball.webp', icon: "🏀", trans: "yo juego básquetbol" },
            { q: "What verb do you use with soccer?", a: "PLAY soccer    or    PLAY football", sideImg: DIBUJOS+'play-soccer.webp', icon: "⚽", trans: "yo juego fútbol" },
            { q: "What verb do you use with tennis?", a: "PLAY tennis", sideImg: DIBUJOS+'play-tennis.webp', icon: "🎾", trans: "yo juego tenis" },
            { q: "What verb do you use with handball?", a: "PLAY handball", sideImg: DIBUJOS+'play-handball.webp', icon: "🤾", trans: "yo juego balonmano" },
            { q: "What verb do you use with swimming?", a: "GO swimming", sideImg: DIBUJOS+'go-swimming.webp', icon: "🏊", trans: "yo voy a nadar" },
            { q: "What verb do you use with skiing?", a: "GO skiing", sideImg: DIBUJOS+'go-skiing.webp', icon: "⛷️", trans: "yo voy a esquiar" },
            { q: "What verb do you use with running?", a: "GO running", sideImg: DIBUJOS+'go-running.webp', icon: "🏃", trans: "yo voy a correr" },
    ...
    },
    {
        ...
        items: [
            { q: "What do you think about basketball?", a: "In my opinion, basketball is exciting!", sideImg: DIBUJOS+'play-basketball.webp', icon: "🏀" },
            { q: "What do you think about soccer?", a: "In my opinion, soccer is fun!", sideImg: DIBUJOS+'play-soccer.webp', icon: "⚽" },
            { q: "What do you think about swimming?", a: "In my opinion, swimming is relaxing!", sideImg: DIBUJOS+'go-swimming.webp', icon: "🏊" },
            { q: "What do you think about tennis?", a: "In my opinion, tennis is interesting!", sideImg: DIBUJOS+'play-tennis.webp', icon: "🎾" },
            { q: "What do you think about skiing?", a: "In my opinion, skiing is dangerous!", sideImg: DIBUJOS+'go-skiing.webp', icon: "⛷️" },
            { q: "What do you think about running?", a: "In my opinion, running is boring / fun!", sideImg: DIBUJOS+'go-running.webp', icon: "🏃" },
            { q: "What do you think about handball?", a: "In my opinion, handball is exciting!", sideImg: DIBUJOS+'play-handball.webp', icon: "🤾" },
    ...
    },
    {
        ...
        items: [
            ...
            { q: "Grandma / cook soup  ↔  we / set the table", a: "While Grandma was cooking soup, we were setting the table.", icon: "🍲" },
    ...
    },
    {
        ...
        items: [
            { q: "Action: Kick the ball!", icon: "🦵", sideImg: DIBUJOS+"patearPelota.webp", answers: [
                ...
                { label: "He", text: "He was KICKING the ball!" },
                { label: "They", text: "They were KICKING the ball!" },
            ] },
            { q: "Action: Bounce the ball!", icon: "⛹️", sideImg: DIBUJOS+"boteoPelota.webp", answers: [
                { label: "She", text: "She was BOUNCING the ball!" },
                { label: "He", text: "He was BOUNCING the ball!" },
                { label: "They", text: "They were BOUNCING the ball!" },
            ] },
            { q: "Action: Throw the ball!", icon: "🤾", sideImg: DIBUJOS+"basketball1.webp", answers: [
                { label: "She", text: "She was THROWING the ball!" },
                { label: "He", text: "He was THROWING the ball!" },
                { label: "They", text: "They were THROWING the ball!" },
            ] },
            { q: "Action: Catch the ball!", icon: "🧤", sideImg: DIBUJOS+"atrapaPelota.webp", answers: [
                { label: "She", text: "She was CATCHING the ball!" },
                { label: "He", text: "He was CATCHING the ball!" },
                { label: "They", text: "They were CATCHING the ball!" },
            ] },
            { q: "Action: Hit the ball!", icon: "🏏", sideImg: DIBUJOS+"baseballBateo.webp", answers: [
                { label: "She", text: "She was HITTING the ball!" },
                { label: "He", text: "He was HITTING the ball!" },
                { label: "They", text: "They were HITTING the ball!" },
            ] },
            { q: "Action: Ride a bicycle!", icon: "🚲", sideImg: DIBUJOS+"bicycle1.webp", answers: [
                { label: "She", text: "She was RIDING a bicycle!" },
                { label: "He", text: "He was RIDING a bicycle!" },
                { label: "They", text: "They were RIDING a bicycle!" },
            ] },
            { q: "Action: Swim!", icon: "🏊", sideImg: DIBUJOS+"go-swimming.webp", answers: [
                { label: "She", text: "She was SWIMMING!" },
                { label: "He", text: "He was SWIMMING!" },
                { label: "They", text: "They were SWIMMING!" },
            ] },
            { q: "Action: Take photos!", icon: "📸", sideImg: DIBUJOS+"foto.webp", answers: [
                { label: "She", text: "She was TAKING photos!" },
                { label: "He", text: "He was TAKING photos!" },
                { label: "They", text: "They were TAKING photos!" },
            ] },
            { q: "Action: Play cards!", icon: "🃏", sideImg: DIBUJOS+"cards.webp", answers: [
                { label: "She", text: "She was PLAYING cards!" },
                { label: "He", text: "He was PLAYING cards!" },
                { label: "They", text: "They were PLAYING cards!" },
            ] },
            { q: "Action: Dance!", icon: "💃", sideImg: DIBUJOS+"dancing2.webp", answers: [
                { label: "She", text: "She was DANCING!" },
                { label: "He", text: "He was DANCING!" },
                { label: "They", text: "They were DANCING!" },
            ] },
        ]
    },
    {
