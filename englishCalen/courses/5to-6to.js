...
COURSES['5to-6to'] = {
    ...
    },
    {
        ...
        aLabel: "Answer",
        items: [
            { q: "Japanese", a: "✅ YES! /iː/ — JapanESE", icon: "🔊" },
            { q: "cheese", a: "✅ YES! /iː/ — chEEse", icon: "🔊" },
            { q: "speak", a: "✅ YES! /iː/ — spEAk", icon: "🔊" },
            { q: "three", a: "✅ YES! /iː/ — thrEE", icon: "🔊" },
            { q: "beach", a: "✅ YES! /iː/ — bEAch", icon: "🔊" },
            { q: "sea", a: "✅ YES! /iː/ — sEA", icon: "🔊" },
            { q: "tea", a: "✅ YES! /iː/ — tEA", icon: "🔊" },
            { q: "easy", a: "✅ YES! /iː/ — EAsy", icon: "🔊" },
            { q: "eagle", a: "✅ YES! /iː/ — EAgle", icon: "🔊" },
            { q: "green", a: "✅ YES! /iː/ — grEEn", icon: "🔊" },
            { q: "hello", a: "❌ NO! Not /iː/", icon: "🔇" },
            { q: "car", a: "❌ NO! Not /iː/", icon: "🔇" },
            { q: "ball", a: "❌ NO! Not /iː/", icon: "🔇" },
            { q: "match", a: "❌ NO! Not /iː/", icon: "🔇" },
            { q: "French", a: "❌ NO! Not /iː/", icon: "🔇" },
        ]
    },
    {
        ...
        aLabel: "Faster!",
        items: [
            { q: "Tea with cream for me, please.", a: "🏆 Say it faster!", icon: "👅" },
            { q: "It's easy to see the eagle on the green tree.", a: "🏆 Say it faster!", icon: "👅" },
            { q: "Please freeze the cheese with ease.", a: "🏆 Say it faster!", icon: "👅" },
            { q: "She sees the sea and the sea sees her.", a: "🏆 Say it faster!", icon: "👅" },
        ]
    },
        ]
    },
