...
const ALREADY_KNOW_ENGLISH = [
    ...
    { q: "¿Cómo se llama esa masa redonda con jamón y queso que viene de Italia?", a: "PIZZA", icon: "🍕" },
    { q: "¿Cómo se llama esa comida de Japón que son rollos de arroz con carne?", a: "SUSHI", sideImg: IMG+"sushi.png" },
