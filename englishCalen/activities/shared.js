...
const ALREADY_KNOW_ENGLISH = [
    ...
    { q: "¿Cómo se llama esa foto de un artista famoso que uno puede pegar en su pieza?", a: "POSTER", sideImg: DIBUJOS+"poster.webp" },
    ...
    { q: "¿Cómo se le dice a alguien que adquiere fama en TikTok o Instagram?", a: "INFLUENCER", sideImg: DIBUJOS+"influencer.webp" },
    { q: "Si te gusta mucho un video en TikTok o Instagram, tú le das un...", a: "LIKE", icon: "👍" },
    { q: "¿Cómo se llama quien juega muchos videojuegos?", a: "GAMER", sideImg: DIBUJOS+"gamer.webp" },
